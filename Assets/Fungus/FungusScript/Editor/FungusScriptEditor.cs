...
namespace Fungus
{
	...
	public class FungusScriptEditor : Editor 
	{
		...
		protected SerializedProperty defaultSayProp;
		protected SerializedProperty defaultChooseProp;
		...
		protected virtual void OnEnable()
		{
			...
			defaultSayProp = serializedObject.FindProperty("defaultSay");
			defaultChooseProp = serializedObject.FindProperty("defaultChoose");
		...
		public override void OnInspectorGUI() 
		{
			...
			EditorGUILayout.PropertyField(portraitStageProp);
			EditorGUILayout.PropertyField(defaultSayProp);
			EditorGUILayout.PropertyField(defaultChooseProp);
