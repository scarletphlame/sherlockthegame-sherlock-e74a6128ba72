...
namespace Fungus
{
	...
	public class FungusScript : MonoBehaviour 
	{
		...
		/**
	 	 * Default Say Dialog box to use for this game.
	 	 */
		[Tooltip("Default Say Dialog box to use for this game")]
		public SayDialog defaultSay;
		
		/**
	 	 * Default Choose Dialog box to use for this game.
	 	 */
		[Tooltip("Default Choose Dialog box to use for this game")]
		public ChooseDialog defaultChoose;
